...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтрШаблон("%1: %2", ФразаИнтерфейса("Поиск"), ПолноеИмяМетаданных);
...
Функция ВсеВидыПоиска()
   	...
   	Результат.Вставить("УникальныйИдентификатор", ФразаИнтерфейса("Уникальный идентификатор"));
	Результат.Вставить("БитаяСсылка", ФразаИнтерфейса("Битая ссылка"));
	Результат.Вставить("СсылкаСУБД", ФразаИнтерфейса("Ссылка СУБД"));
	Результат.Вставить("НавигационнаяСсылка", ФразаИнтерфейса("Навигационная ссылка"));
	Результат.Вставить("Код", ФразаИнтерфейса("Код"));
	Результат.Вставить("Номер", ФразаИнтерфейса("Номер"));
	Результат.Вставить("Наименование", ФразаИнтерфейса("Наименование"));
...
Процедура НайтиСсылкиПоКоду(ОбъектМетаданных)
	...
	ИмяРеквизита = ФразаИнтерфейса("Код");
	НайтиСсылкиПоРеквизиту(ОбъектМетаданных, ИмяРеквизита, ВидПоиска);
...
Процедура НайтиСсылкиПоНомеру(ОбъектМетаданных)
	...
	ИмяРеквизита = ФразаИнтерфейса("Номер");
	НайтиСсылкиПоРеквизиту(ОбъектМетаданных, ИмяРеквизита, ВидПоиска);
...
Процедура НайтиСсылкиПоНаименованию(ОбъектМетаданных)
	...
	ИмяРеквизита = ФразаИнтерфейса("Наименование");
	НайтиСсылкиПоРеквизиту(ОбъектМетаданных, ИмяРеквизита, ВидПоиска);
...
Процедура НайтиСсылкиПоРеквизиту(ОбъектМетаданных, ИмяРеквизита, ВидПоиска)
	...
	ОператорВыбора.Источники.Добавить(ПолноеИмяМетаданных);
	ОператорВыбора.ВыбираемыеПоля.Добавить(ФразаИнтерфейса("Ссылка"));
	ОператорВыбора.ВыбираемыеПоля.Добавить(ФразаИнтерфейса("Представление"));
	ОператорВыбора.Отбор.Добавить(ТекстУсловия);
...
Процедура ЗаполнитьДоступныйВидПоиска_Код(ОбъектМетаданных)
	...
	ИмяРеквизита = ФразаИнтерфейса("Код");
	Если ЕстьСтандартныйРеквизитОбъектаМетаданных(ОбъектМетаданных, ИмяРеквизита) Тогда
...
Функция ОбъектМетаданных()
	...
	Если ОбъектМетаданных = Неопределено Тогда
		ТекстИсключения = ФразаИнтерфейса("Не найден объект метаданных");
		ТекстИсключения = СтрШаблон("%1 %2", ТекстИсключения, ПолноеИмяМетаданных);
