...
Процедура ЗаполнитьКомандыВычисленияВыражения(ПараметрыПоиска, ОбщаяКоманда)
	...
	КомандаЭлементы.ВыполняемоеДействие = РГП_ГлобальныйПоискКлиентСервер.ВыполняемоеДействиеВычисленияВыражения(ОсновнаяКоманда.ПолныйКлюч, Ложь);
	...
	КомандаЭлементы.Картинка = БиблиотекаКартинок.СформироватьОтчет;
	КомандаЭлементы.ВыполняемоеДействие = РГП_ГлобальныйПоискКлиентСервер.ВыполняемоеДействиеВычисленияВыражения(ОсновнаяКоманда.ПолныйКлюч, Истина);
...
Процедура ЗаполнитьКомандыПоискаМетаданныхРасширенногоГлобальногоПоиска(ПараметрыПоиска, ОбщаяКоманда)
	...
	КомандаПоискаМетаданных = НоваяКомандаРасширенногоПоиска(ПараметрыПоиска, КлючКомандыПоискаПоМетаданным(), ОбщаяКоманда);
