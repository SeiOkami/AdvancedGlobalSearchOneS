...
Процедура ОбработчикОповещенияСкопироватьВБуфер(ВыполняемоеДействие, КопируемыйТекст) Экспорт
	...
	ПомещаемыеДанные = Новый Массив; // Массив из ЭлементБуфераОбмена
	ПомещаемыеДанные.Добавить(Новый ЭлементБуфераОбмена(СтандартныйФорматДанныхБуфераОбмена.Текст, КопируемыйТекст));
