...
Функция ВыполняемоеДействиеПустое() Экспорт
	...
	Возврат ВыполняемоеДействиеОткрытияЗначения(Неопределено);
...
// * ГруппироватьСтандартныеКоманды - Булево - Необходимо ли группировать стандартные команды в одном элементе результата
// * ДополнительныеПараметры - Структура из КлючИЗначение:
// ** Ключ - Строка
// ** Значение - Произвольный
...
Функция ЭлементРезультатаКомандаВводаСтроки(ПараметрыВыполнения) Экспорт
	...
	Если ЗначениеЗаполнено(НачальнаяСтрока) И НЕ ПараметрыВыполнения.ГруппироватьСтандартныеКоманды Тогда
