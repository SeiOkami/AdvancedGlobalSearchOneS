...
// * ДобавитьДействиеАнализДанных - Булево - Необходимо ли добавить действие открытия генерируемого ДС со всеми полями
...
Функция ПараметрыВыполненияГлобальногоПоискаМетаданных(ИзначальнаяСтрокаПоиска, ПараметрыВыполнения) Экспорт
	...
	Результат.Вставить("ДобавитьДействиеАнализДанных", ЭтоПолноправныйПользователь());
...
Процедура ГлобальныйПоискМетаданные_ЗаполнитьРезультатыПоиска(ОбщиеПараметры, РезультатыПоиска)
	...
	Для Каждого СтрокаМетаданных Из ПодходящиеМетаданные Цикл
		...
		Если ОбщиеПараметры.ДобавитьДействиеАнализДанных Тогда
...
Процедура ДобавитьМетаданныеВСловарь(Знач Словарь, Знач КоллекцияМетаданных, Знач ИмяКоллекции, Знач ИмяКоллекцииЕд, Знач СокращенияТипа = "")
	...
	Для Каждого ОбъектМетаданных Из КоллекцияМетаданных Цикл
		...
		НоваяСтрока.ЕстьПравоПоиска = ЕстьПравоВводаПоСтрокеОбъектаМетаданных(ОбъектМетаданных);
		НоваяСтрока.ЕстьПравоСоздания = ЕстьПравоСозданияОбъектаМетаданных(ОбъектМетаданных);
...
Функция ЕстьПравоСозданияОбъектаМетаданных(ОбъектМетаданных)
	...
	Исключение
		Попытка
			ЕстьПравоСоздания = ПравоДоступа("Редактирование", ОбъектМетаданных);
		Исключение
