...
Функция СловарьГлобальногоПоискаМетаданных(ИзКэша = Истина) Экспорт
	...
	ДобавитьМетаданныеВСловарь(Словарь, 
		Метаданные.Задачи, "Задачи", "Задача", Истина, Истина, "Здч,Задачи,Задача");
	
	ДобавитьМетаданныеВСловарь(Словарь, 
		Метаданные.Обработки, "Обработки", "Обработка", Ложь, Ложь, "Обр");
		
	ДобавитьМетаданныеВСловарь(Словарь, 
		Метаданные.Отчеты, "Отчеты", "Отчет", Ложь, Ложь, "Отч");
		
	ДобавитьМетаданныеВСловарь(Словарь, 
		Метаданные.ПланыВидовРасчета, "ПланыВидовРасчета", "ПланВидовРасчета", Истина, Истина, "ПВР,ПланВидаРасчета,ПланРасчета");
...
Функция КоллекцияМетаданныхСловаряГлобальногоПоиска()
	...
	Результат.Колонки.Добавить("ЭтоТаблицаДанных" , Новый ОписаниеТипов("Булево"));
	Результат.Колонки.Добавить("ЕстьПравоСоздания", Новый ОписаниеТипов("Булево"));
	Результат.Колонки.Добавить("ЕстьПравоПоиска"  , Новый ОписаниеТипов("Булево"));
...
Процедура ДобавитьМетаданныеВСловарь(Знач Словарь, Знач КоллекцияМетаданных, 
	...
	Для Каждого ОбъектМетаданных Из КоллекцияМетаданных Цикл
		...
		Если ЭтоТаблицаДанных Тогда
			...
			ВозможноСоздание = ЭтоСсылочныйТип 
...
Функция КлючевыеСловаПоискаОбъектаМетаданных(ОбъектМетаданных)
	...
	СвойстваМетаданного = Новый Структура(ДополнительныеСвойства);
	ЗаполнитьЗначенияСвойств(СвойстваМетаданного, ОбъектМетаданных);
	Для Каждого КлючИЗначение Из СвойстваМетаданного Цикл
