...
Процедура ДобавитьМетаданныеВСловарь(Знач Словарь, Знач КоллекцияМетаданных, 
	...
	Для Каждого ОбъектМетаданных Из КоллекцияМетаданных Цикл
		...
		НоваяСтрока.КлючевыеСлова = КлючевыеСловаПоискаОбъектаМетаданных(ОбъектМетаданных);
...
// Возвращаемое значение:
//  Строка
Функция КлючевыеСловаПоискаОбъектаМетаданных(ОбъектМетаданных)
	...
	Для Каждого КлючИЗначение Из СвойстваМетаданных Цикл
		Если ЗначениеЗаполнено(КлючИЗначение.Значение) Тогда
			КлючевыеСлова.Добавить(ВРег(Строка(КлючИЗначение.Значение)));
		КонецЕсли;
	КонецЦикла;
