...
Процедура ГлобальныйПоискМетаданные_НайтиПодходящиеМетаданные(ОбщиеПараметры)
	...
	Если УказанКлючТипа И НЕ ВыводВсехТипов Тогда
...
Процедура ГлобальныйПоискМетаданные_ОбработатьПриоритетСтрокиСловаря(ОбщиеПараметры, СтрокаСловаря, Приоритет)
	...
	Если Приоритет > 0 Тогда
		ГлобальныйПоискМетаданные_ДобавитьПодходящиеМетаданные(ОбщиеПараметры, СтрокаСловаря, Приоритет);
	КонецЕсли;
...
//  СтрокаСловаря - см. ГлобальныйПоискМетаданные_ОбработатьСтрокуСловаря.СтрокаСловаря
//  Приоритет - Число
Процедура ГлобальныйПоискМетаданные_ДобавитьПодходящиеМетаданные(ОбщиеПараметры, СтрокаСловаря, Приоритет = 0)
...
Процедура ГлобальныйПоискМетаданные_ВывестиБазовыеКлассы(ОбщиеПараметры, РезультатыПоиска)
	...
	Для Каждого БазовыйКласс Из ОбщиеПараметры.ПодходящиеБазовыеКлассы Цикл
		...
		ПередаваемыеПараметры = Копия(ПараметрыВыполнения.ПараметрыКоманды);
		...
		РГП_ГлобальныйПоискКлиентСервер.ДобавитьЭлементРезультатаГлобальногоПоиска(РезультатыПоиска, 
			ВыполняемоеДействие, БазовыйКласс.ПредставлениеТипа, БазовыйКласс.Картинка);
...
Функция КоллекцияМетаданныхПодходящиеБазовыеКлассы()
	...
	Результат.Колонки.Добавить("ИмяТипаВрег", Новый ОписаниеТипов("Строка"));
	Результат.Колонки.Добавить("ПредставлениеТипа", Новый ОписаниеТипов("Строка"));
...
Процедура ДобавитьМетаданныеВСловарь(Знач Словарь, Знач КоллекцияМетаданных, 
	...
	Для Каждого ОбъектМетаданных Из КоллекцияМетаданных Цикл
		...
		НоваяСтрока.ПредставлениеТипа = ?(ПредставлениеТипа = "", ИмяКоллекции, ПредставлениеТипа);
